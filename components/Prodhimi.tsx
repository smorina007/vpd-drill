...
const produktet = [
  {
    name: 'Muri L',
    description: 'Elemente betoni për mure mbajtëse dhe kanale. Prodhohen me standarde të larta cilësie.',
    icon: FaCube,
    specs: [
    ...
    image: '/images/prodhimi/muri-l.jpg'
  },
  {
    name: 'Gypa betoni',
    description: 'Për kanalizime dhe ujësjellës. Tubacion i qëndrueshëm për infrastrukturë nëntokësore.',
    icon: FaCube,
    specs: [
    ...
    image: '/images/prodhimi/gypa.jpg'
  },
  {
    name: 'Pllaka betoni',
    ...
    image: '/images/prodhimi/pllaka.jpg'
  }
]
          ...
          {produktet.map((produkt, index) => (
            ...
            >
              ...
              <div className="p-8">
                ...
                <Link
                  href="/kontakti"
                  className="inline-flex items-center justify-center w-full bg-gradient-to-r from-[#256D7B] to-[#1a4f5a] text-white px-6 py-4 rounded-xl font-semibold hover:shadow-lg transform hover:-translate-y-0.5 transition-all duration-300 group/btn"
                >
